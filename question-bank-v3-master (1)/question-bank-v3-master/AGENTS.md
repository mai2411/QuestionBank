...
This is a modern fullstack TypeScript web app built with Bun runtime, featuring Elysia.js backend and React frontend with end-to-end type safety via Eden Treaty.
